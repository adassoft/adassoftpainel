<div class="text-xs text-gray-600 dark:text-gray-400">
    <p class="mb-2">Use as variáveis abaixo para personalizar a mensagem. Elas serão substituídas pelos dados reais no
        momento do envio.</p>
    ...
    <ul class="space-y-1">
        ...
        <li><code class="text-primary-600 font-bold">{days}</code> Dias restantes (apenas no aviso prévio)</li>
        <li><code class="text-primary-600 font-bold">{id}</code> Número do pedido</li>
    </ul>
</div>