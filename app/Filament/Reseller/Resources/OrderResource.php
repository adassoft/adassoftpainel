        ...
        return $table
            ...
            ->actions([
                Action::make('liberar')
                    ...
                    ->visible(fn(Order $record) => strtolower($record->situacao) === 'pago' && $record->status_entrega !== 'entregue')
                ...
                Action::make('receber')
                    ...
                    ->button()
                    ->extraAttributes(['style' => 'display: none !important'])
                    ->visible(fn(Order $record) => strtolower($record->situacao) !== 'pago' && strtolower($record->situacao) !== 'cancelado')
                    ->requiresConfirmation()
