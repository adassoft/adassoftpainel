        ...
        return $table
            ...
            ->actions([
                Action::make('liberar')
                    ...
                    ->visible(fn(Order $record) => in_array(strtolower($record->status), ['pago', 'paid']) && $record->status_entrega !== 'entregue')
                ...
                Action::make('receber')
                    ...
                    ->button()
                    ->extraAttributes(['style' => 'display: none !important'])
                    ->visible(fn(Order $record) => !in_array(strtolower($record->status), ['pago', 'paid', 'cancelado', 'cancelled', 'refused']))
                    ->requiresConfirmation()
